...
export const TicketVariantItem = ({ index, register, onRemove, errors, control }: VariantItemProps) => {
	const getFieldName = <T extends FieldPath<iTicketVariant>>(field: T): `variant.${number}.${T}` =>
		`variant.${index}.${field}`;
