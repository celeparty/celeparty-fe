												...
												<div className="mt-6">
													<div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
														...
														<p className="text-sm text-blue-600 mb-4">
															Lengkapi data penerima untuk setiap tiket yang akan dibeli.
															Pastikan data sesuai dengan identitas asli.
														</p>
													</div>
													...
													<div className="space-y-4">
														{Array.from({ length: item.quantity }, (_, idx) => {
															...
															const defaultName = isFirstRecipient
																? session?.user?.name || ""
																: "";
															const defaultEmail = isFirstRecipient ? userEmail : "";
															const defaultIdentityType = isFirstRecipient
																? "KTP"
																: "KTP";
															const defaultIdentityNumber = isFirstRecipient
																? session?.user?.nik || ""
																: "";
															const defaultWhatsappNumber = isFirstRecipient
																? userTelp
																: "";
																	...
																	<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
																		...
																		<div className="space-y-1">
																			...
																			<input
																				...
																				value={
																					currentRecipient.name || defaultName
																				}
																				onChange={(e) => {
																					const newRecipients = [
																						...(item.recipients || []),
																					];
																					if (!newRecipients[idx])
																						newRecipients[idx] = {
																							name: defaultName,
																							identity_type:
																								defaultIdentityType,
																		...
																		<div className="space-y-1">
																			...
																			<select
																				...
																				onChange={(e) => {
																					...
																					newRecipients[idx].identity_type = e
																						.target.value as
																						| "KTP"
																						| "SIM"
																						| "Lainnya";
																		...
																		<div className="space-y-1">
																			...
																			<input
																				...
																				onChange={(e) => {
																					...
																					newRecipients[idx].identity_number =
																			...
																			{(!currentRecipient.identity_number ||
																				...
																				<p className="text-xs text-red-600">
																					Nomor identitas wajib diisi dengan
																					angka
																				</p>
																			)}
																		</div>
																		...
																		<div className="space-y-1">
																			...
																			<input
																				...
																				onChange={(e) => {
																					...
																					newRecipients[idx].whatsapp_number =
																						e.target.value.replace(
																							/\D/g,
																							"",
																						);
																			...
																			{(!currentRecipient.whatsapp_number ||
																				...
																				<p className="text-xs text-red-600">
																					Nomor WhatsApp wajib diisi dengan
																					angka
																				</p>
																			)}
																		</div>
																	...
																	{hasErrors && (
																		<div className="mt-3 p-2 bg-red-100 border border-red-200 rounded-md">
																			<p className="text-xs text-red-700">
																				⚠️ Lengkapi semua field yang wajib diisi
														...
														<div className="flex items-start gap-2">
															...
															<div>
																...
																<ul className="text-xs text-green-700 space-y-1">
																	<li>
																		• Pastikan data penerima sesuai dengan identitas
																		asli
																	</li>
																	<li>
																		• E-tiket akan dikirim ke email yang terdaftar
																	</li>
