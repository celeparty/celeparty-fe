		...
		<div className="relative wrapper py-7 bg-[#CBD002] my-5 rounded-lg">
			<div className="w-[260px] mx-auto py-8">
				<div className="flex justify-center">
					<Image src={"/images/cake-color-white.png"} width={111} height={80} alt="Cake Color.." />
				</div>
				<h1 className="text-[26px] text-center font-semibold text-white mb-7">CELEPARTNER</h1>
