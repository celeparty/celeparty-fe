...
export default function AddProductPage() {
  ...
  return (
    ...
    <div className="flex justify-stretch mt-7 rounded-t-lg overflow-hidden">
      <button className={`${productType === "product" ? "bg-c-green text-white":"bg-slate-300 "} flex-1 py-2`} onClick={() => setProductType("product")}>Produk</button>
      <button className={`${productType === "ticket" ? "bg-c-green text-white":"bg-slate-300 "} flex-1 py-2`} onClick={() => setProductType("ticket")}>Tiket</button>
    </div>
