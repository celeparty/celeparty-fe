      ...
      <div className="max-w-[707px] mx-auto  leading-[20px] pt-8 pb-12">
        ...
        <div className="font-hind font-normal text-[12px] text-white mb-4">
          ...
          <p>
            ...
            untuk melindungi informasi pribadi yang Anda bagikan kepada kami.
            Kebijakan Privasi ini menjelaskan bagaimana kami mengumpulkan,
            menggunakan, mengungkapkan, dan melindungi informasi yang kami
            peroleh melalui website kami, layanan kami, dan aplikasi kami
        ...
        <div className="font-hind font-normal [&_h5]:font-bold text-[12px] text-white mb-4">
          ...
          <p>
            ...
            sukarela kepada kami, seperti nama, alamat email, nomor telepon,
            alamat, dan informasi lainnya yang Anda bagikan saat mendaftar atau
        ...
        <div className="font-hind font-normal [&_h5]:font-bold text-[12px] text-white mb-4">
          ...
          <p>
            ...
            Anda menggunakan Layanan kami, seperti alamat IP, jenis perangkat,
            browser yang digunakan, aktivitas browsing, dan informasi lainnya
        ...
        <div className="font-hind font-normal [&_h5]:font-bold text-[12px] text-white mb-4">
          ...
          <p>
            ...
            mengelola, dan meningkatkan Layanan kami. Ini mencakup pemrosesan
            pesanan, komunikasi dengan Anda, memberikan dukungan pelanggan, dan
        ...
        <div className="font-hind font-normal [&_h5]:font-bold text-[12px] text-white mb-4">
          ...
          <p>
            ...
            mengelola situs web, memperbaiki kinerja, dan menyelidiki potensi
            pelanggaran hukum.
          </p>
        </div>
        <div className="font-hind font-normal [&_h5]:font-bold text-[12px] text-white mb-4">
          ...
          <p>
            ...
            Anda dengan pihak ketiga tanpa izin Anda, kecuali yang diizinkan
            oleh hukum. Namun, kami dapat mengungkapkan informasi Anda kepada
            pihak ketiga yang memberikan layanan kepada kami, seperti penyedia
            layanan hosting, analitik, atau pembayaran, sesuai dengan kebutuhan
        ...
        <div className="font-hind font-normal [&_h5]:font-bold text-[12px] text-white mb-4">
          ...
          <p>
            ...
            informasi Anda dari akses, pengungkapan, perubahan, atau
            penghancuran yang tidak sah. Namun, kami tidak dapat menjamin
        ...
        <div className="font-hind font-normal [&_h5]:font-bold text-[12px] text-white mb-4">
          ...
          <p>
            ...
            sesuai dengan perubahan dalam praktik kami atau perubahan hukum yang
            berlaku. Perubahan tersebut akan diberlakukan segera setelah kami
        ...
        <div className="font-hind font-normal [&_h5]:font-bold text-[12px] text-white mb-4">
          ...
          <p>
            ...
            Privasi kami, atau jika Anda ingin mengakses, mengoreksi, atau
            menghapus informasi pribadi Anda yang kami miliki, silakan hubungi
