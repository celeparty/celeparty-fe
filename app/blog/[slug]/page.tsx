                    ...
                    <div className="flex flex-wrap -mx-5">
                        <div className="w-8/12 px-5">
                            ...
                            <div className="relative text-sm text-c-gray-text2 my-2">
                                {dataContent?.author ? "Author: " + dataContent?.author + " - " : null}{moment(dataContent?.publish_at).format("DD MMM YYYY")}
                            </div>
                        </div>
                        ...
                        <div className="w-8/12 px-5">
                            <div className="relative">
                                <div className="relative">
                                    {
                                        dataContent?.thumbnail && <div className="relative fill-current w-full h-[450px] overflow-hidden">
                                            <Image
                                    ...
                                    <div className="my-5 text-c-gray-text">
