...
export default async function BlogDetail({
	...
	const imageUrl = dataContent?.image?.data?.attributes?.formats?.large?.url
					...
					<div className="wrapper">
						<div className="flex lg:flex-row flex-col flex-wrap -mx-5">
							...
							<div className="w-full lg:w-9/12 px-5">
								...
								{/* Produk terkait */}
								{Array.isArray(dataContent?.products) && dataContent.products.length > 0 && (
									<div className="products-wrapper mt-4">
										<h4 className="font-semibold text-[16px] text-black">Produk Terkait</h4>
