    ...
    return (
        <div className={`${small ? "w-full mb-5" : "w-full lg:w-6/12 px-5 pb-5"}`}>
            <div className="flex gap-3">
                <div className={`relative fill-current ${small ? "w-[100px] h-[100px]" : "w-[150px] h-[150px]"} overflow-hidden`}>
                    <Image
                ...
                <div className="flex flex-col gap-3 flex-1">
                    <Link href={slug ? slug : "/"} className="text-black">{title ? title : "no title"}</Link>
