                ...
                status === "authenticated" ?
                    <>
                        ...
                        <div className="text-center mx-auto max-w-[150px]">
                            <input type="button" value="+ Kerajang" className="bg-c-green mt-5 text-white py-3 w-full rounded-lg cursor-pointer" />
                        </div>
                    </> :
                    <div>
                        <h4>Silahkan Login Terlebih Dahulu</h4>
                        <div className="h-14">
                            <Link href="/auth/login" className="btnline justify-center items-start inline-flex"><div className="py-1">Masuk</div></Link>
                        </div>
                    </div>
            }
